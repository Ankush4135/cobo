...
onready var antina_mount_counter_lable = get_node("../Customise/TabContainer/Antenna/antina_mount_counter")
...
onready var right_button_a = get_node("../Customise/TabContainer/Antenna/rightbuttonholder3")
onready var left_button_a = get_node("../Customise/TabContainer/Antenna/leftbuttonholder3")
